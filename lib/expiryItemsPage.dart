    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          Map<String, dynamic> val = documentSnapshot?.data() as Map<String, dynamic>;
          print(val.keys);
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                child: ListTile(
                  title: Text(key),
                  subtitle: Text("Expiry Date: ${value[0]}  Quantity: ${value[1]}"),
                  trailing: IconButton(
                               ...
                               TextButton(
                                 onPressed: () {
                                   if(val.keys.length <= 1){
                                     ...
                                     db.collection('expiryItems').doc(brandName).delete();
                                     Navigator.of(context).pop();
                                     Navigator.of(context).pop();
                                   } else {
