...
import 'package:shmart/screens/old_screens/orderItems.dart';

import 'package:shmart/screens/old_screens/menu.dart';

import 'package:shmart/screens/old_screens/oilPage.dart';

import 'package:shmart/screens/old_screens/SearchPage.dart';

import 'package:shmart/screens/old_screens/login.dart';

import 'package:shmart/screens/old_screens/milkOrder.dart';

import 'package:shmart/screens/old_screens/expiryPage.dart';

import 'package:firebase_core/firebase_core.dart';

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:shmart/screens/old_screens/rackLabel.dart';
import 'package:shmart/screens/old_screens/receivables.dart';
import 'firebase_options.dart';


import 'package:shmart/screens/old_screens/barcodeSticker.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        "/search": (context) => SearchPage(p: p, dbobj: dbobj),
