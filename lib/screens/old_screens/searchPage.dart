...
class SearchPage extends StatefulWidget {
  var p;
  final dbobj;
  SearchPage({super.key, this.p, this.dbobj});
                    ...
                    if (ip != null) {
                      ...
                      if (docSnapshot.exists) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content:
                                    Text("Cant find document from server.")));
                      }
                    }
                    setState(() {});
                  },
              ...
              TextButton(
                  onPressed: () async {
                    ...
                    if (docSnapshot.exists) {
                      ...
                      final fieldValue = data['ipValue'];
                      ipValue.text = fieldValue;
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text("Cant find value from server.")));
                    }
                    setState(() {});
                  },
